                    ...
                    <ul id="menu-top" class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                ...
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="gm11.jsp">灰度预测模型</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="panel-body">
                    ...
                    <span class="publish-time" data-toggle="tooltip" data-placement="bottom"
                          title="最后编辑于 2017.06.20 14:38">2017.06.19 22:17*</span>
                                            <span class="wordage">字数 3225</span>
                                        </div>
                                    </div>
                                    <!-- 如果是当前作者，加入编辑按钮 -->
                                </div>
                                ...
                                <div class="show-content">
                                    ...
                                    </p><h4>4.3 确定合适的 <i>p </i>和 <i>q</i> 值</h4>

                                    <p>经过第2步，我们已经得到了一个稳定的时间序列，现在需要获得p和q，从而确定选择使用哪种模型更合适。</p>

                                    <p>4.3.1 绘制平稳时间序列的自相关图和偏自相关图。</p>
                                    <blockquote>
                                    ...
                                    <p>检验结果是2.02424743723，说明不存在自相关性。<br></p><h4>4.5 模型预测</h4>
